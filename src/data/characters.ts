...
export const CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    summary: '高冷孤傲的复仇少年，实则是典型的 ISFP（艺术家）人格。他的一切重大抉择（哪怕是灭族复仇和斩断光芒）均完全被其极度深沉、排他性极强的内倾情感（Fi）及对氏族荣耀的本能死守所驱动，而不是出于对长效战略控制的渴望，常在强烈情绪冲突中依靠直觉和感官（Se）行动。',
    plotProof: '在灭族惨案后，他没有像逻辑战略家一样蛰伏积聚力量，而是凭借强烈的 Fi 痛苦，义无反顾地叛离木叶寻取力量。他的超凡即时战斗神经反射（Se）与对写轮眼瞳力的极致敏锐度极为出彩。面对终局，他想用“成为世间全部憎恨的承载者”的极端 Fi 价值，来对抗由规则引导的体系秩序。',
    fandomDiscussion: '全球 PDB 社区经过多年论战，最终对佐助达成了高票 consensus：他是极为经典的 ISFP。粉丝广泛指出，他看似冰冷的外壳实则是 Fi 的极佳精神自卫表现，而非 INTJ 的理性冷峻，这纠正了多年来动漫界对他性格底色类型的误判。',
    strengths: ['顶级的战地感官洞察力与超凡的瞬发式刃气爆发能', '对内心认定的尊严红线具有至死不移、纯粹而高贵的死守立场', '极其抗拒任何虚妄教条和虚伪体制的真实生命本色'],
    weaknesses: ['劣势 Te 导致在极端情绪压力下几乎理智全无、陷入歇斯底里的行为失控', '长效情感通道极高防御，习惯用最恶毒冷酷的话语伤害陪伴他的友伴'],
    dimensions: { E: 12, N: 22, T: 35, P: 75 },
    matches: {
      perfect: ['ESTJ', 'ESFJ'],
      good: ['ISTJ', 'ISFP', 'ISTP']
    }
  ...
  },
{
  ...
  },
  {
    ...
    summary: '我爱罗经历了从极端自闭受创（孤影恶魔）到涅槃重生成为极度慈悲、智慧的 INFJ 提倡者的惊人蜕变。他在痛苦深渊中与鸣人产生了灵魂共鸣，从此将毕生精力奉献于守护砂隐村。他成为了最年轻的五影，用极其宽仁和宏大的和平愿景（Ni-Fe）引导 and 呵护着新一代的忍者。',
    plotProof: '在五影会谈上，面对顽固的土影两天秤大野木，我爱罗一句平静却直击灵魂的叩问：“你们是从什么时候开始抛弃自我的？”直接融化了老一辈的心防，展现了他超越凡俗的 INFJ 灵性本质。他在第四次忍界大战前的“忍者联军大动员演讲”，更是将外倾情感（Fe）发挥到淋漓尽致，凭只言片语将宿怨深厚的五大国联军凝聚成钢铁防线。',
    fandomDiscussion: 'PDB 社区对我爱罗的一生评定极高。他是少数能将“重度偏执创伤状态”过渡到“圣人般宁静治愈状态”的典范。粉丝们常常热议，他周围环绕着的“绝对防御沙之壁”其实是他极度敏感、极度渴望爱却又将自己防卫起来的灵魂写照，他是用尽余生去实践“爱”的沙之奉献者。',
    strengths: ['直击人心、化敌为友、极其温暖圣洁的灵魂感召力', '无坚不摧的绝对守护沙遁防御，沉稳如山的抗压性', '能洞穿时代顽固执迷、推动世界大融合的开明格局'],
    weaknesses: ['幼年极其惨烈的创伤导致其对微小敌意偶尔产生防御过载', '习惯于耗尽自己所有的查克拉和元气去守护村落，爱背负沉重哀歌'],
    dimensions: { E: 15, N: 82, T: 25, P: 18 },
    matches: {
      perfect: ['ENFP', 'ENTP'],
      good: ['INFJ', 'ENFJ', 'INFP']
    }
